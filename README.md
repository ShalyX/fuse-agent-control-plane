...
- `/health` is process liveness; `/ready` verifies PostgreSQL, provider configuration, and policy schema v4/v5 (`workloadShadowSchema`) and returns `503` without database error details when unavailable.
